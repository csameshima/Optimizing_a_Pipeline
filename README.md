...
This would assure that both approaches (hyperparemeter tuning and AutoML) performed using the same basis, without the influence of the automatic featurization for AutoML.  
